...
describe('Decorators', () => {
    ...
    describe('Security Decorator', () => {
        ...
        it('should add a security set of roles to methods of a class', () => {
            serviceDecorators.Security(['test-role', 'test-role2'])(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
        ...
        it('should set the authenticator name, when name is provided', () => {
            const role: string = 'test-role';
            const name: string = 'authenticator-name';
            serviceDecorators.Security(role, name)(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
        ...
        it('should set multiple authenticator names', () => {
            ...
            serviceDecorators.Security(role1, name1)(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
            serviceDecorators.Security(role2, name2)(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
    ...
    [
        ...
        describe(`${test.name} Decorator`, () => {
            const processor = (_req: Request) => {
                return;
            };
            it('should add a ServiceProcessor to all methods of a class', () => {
            ...
            it('should add a ServiceProcessor to methods of a class', () => {
                (serviceDecorators as any)[test.name](processor)(
                    TestService.prototype,
                    'test',
                    Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
                );
            ...
            it('should throw an error if receives undefined preprocessor', () => {
                expect(() => {
                    (serviceDecorators as any)[test.name](undefined)(
                        TestService.prototype,
                        'test',
                        Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
                    );
    ...
    describe('AcceptLanguage Decorator', () => {
        ...
        it('should add an accepted language to methods of a class', () => {
            serviceDecorators.AcceptLanguage('en')(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
        ...
        it('should throw an error if receives undefined', () => {
            expect(() => {
                serviceDecorators.AcceptLanguage(undefined)(
                    TestService.prototype,
                    'test',
                    Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
                );
        ...
        it('should throw an error if receives nothing', () => {
            expect(() => {
                serviceDecorators.AcceptLanguage()(
                    TestService.prototype,
                    'test',
                    Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
                );
    ...
    describe('Accept Decorator', () => {
        ...
        it('should add an accepted content type to methods of a class', () => {
            serviceDecorators.Accept('application/json')(
                TestService.prototype,
                'test',
                Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
            );
        ...
        it('should throw an error if receives undefined', () => {
            expect(() => {
                serviceDecorators.Accept(undefined)(
                    TestService.prototype,
                    'test',
                    Object.getOwnPropertyDescriptor(TestService.prototype, 'test')
                );
    ...
    describe('IgnoreNextMiddlewares Decorator', () => {
        it('should bind a class, making server does not call next function after invocations', () => {
        ...
        it('should bind a method, making server does not call next function after invocations', () => {
            const methodName = 'test';
            serviceDecorators.IgnoreNextMiddlewares(
                TestService.prototype,
                methodName,
    ...
    [
        ...
        describe(`${test.name} Decorator`, () => {
            it(`should bind the HTTP ${test.name} verb to one service method`, () => {
                ...
                (methodDecorators as any)[test.name](
                    TestService,
                    methodName,
            ...
            it(`should bind the HTTP ${test.name} verb to one service method with a cookie param`, () => {
                ...
                testMethod.parameters.push(new MethodParam(name, String, ParamType.cookie));
            ...
            it(`should bind the HTTP ${test.name} verb to one service method with a file param`, () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(name, String, ParamType.file));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it(`should bind the HTTP ${test.name} verb to one service method with a files param`, () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(name, String, ParamType.files));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it(`should bind the HTTP ${test.name} verb to one service method with a multi type param`, () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(name, String, ParamType.param));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it(`should bind the HTTP ${test.name} verb to one service method with a form param`, () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(name, String, ParamType.form));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it('should throw an error if more than one body param', () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(`${name}1`, String, ParamType.body));
                testMethod.parameters.push(new MethodParam(`${name}2`, String, ParamType.body));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it('should throw an error if has a body and a form param', () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(`${name}1`, String, ParamType.body));
                testMethod.parameters.push(new MethodParam(`${name}2`, String, ParamType.form));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
            ...
            it('should throw an error if has a form and a body param', () => {
                ...
                const testMethod = new ServiceMethod();
                testMethod.parameters.push(new MethodParam(`${name}1`, String, ParamType.form));
                testMethod.parameters.push(new MethodParam(`${name}2`, String, ParamType.body));
                serverContainer.registerServiceMethod.mockReturnValue(testMethod);
    ...
    // eslint-disable-next-line prefer-arrow/prefer-arrow-functions
    function validateServiceMethodParameter(type: any, paramType: ParamType, paramIndex: number, name: string) {
